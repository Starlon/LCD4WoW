...
local silent = true
Locale.L = setmetatable({}, silent and readmetasilent or readmeta)
...
Locale.apps = Locale.apps or {}          -- array of ["AppName"]=localetableref
Locale.appnames = Locale.appnames or {}  -- array of [localetableref]="AppName"
...
-- @usage
-- -- enUS.lua
-- local L = LibStub("Locale-3.0"):NewLocale("TestLocale", "enUS", true)
-- L["string1"] = true
--
-- -- deDE.lua
-- local L = LibStub("Locale-3.0"):NewLocale("TestLocale", "deDE")
...
function Locale:GetLocale(application, silent)
	...
	return Locale.apps[application]
end
